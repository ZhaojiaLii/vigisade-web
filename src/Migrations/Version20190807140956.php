 ...
 */
final class Version20190807140956 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE corrective_action (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, question_id INT DEFAULT NULL, result_id INT DEFAULT NULL, area_id INT DEFAULT NULL, status VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, comment_question LONGTEXT DEFAULT NULL, INDEX IDX_ECD872CEA76ED395 (user_id), INDEX IDX_ECD872CE1E27F6BF (question_id), INDEX IDX_ECD872CE7A7B643 (result_id), INDEX IDX_ECD872CEBD0F409C (area_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE dangerous_situation (id INT AUTO_INCREMENT NOT NULL, type_dangerous_situation_id INT NOT NULL, direction_id INT NOT NULL, area_id INT NOT NULL, entity_id INT NOT NULL, user_id INT NOT NULL, date DATETIME NOT NULL, comment LONGTEXT NOT NULL, photo VARCHAR(255) DEFAULT NULL, INDEX IDX_6C25E8364AC461E8 (type_dangerous_situation_id), INDEX IDX_6C25E836AF73D997 (direction_id), INDEX IDX_6C25E836BD0F409C (area_id), INDEX IDX_6C25E83681257D5D (entity_id), INDEX IDX_6C25E836A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
