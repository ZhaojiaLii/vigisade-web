 ...
 */
final class Version20190704094707 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE survey_category (id INT AUTO_INCREMENT NOT NULL, survey_id INT NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_5ABB5FE6B3FE509D (survey_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, direction_id INT DEFAULT NULL, area_id INT DEFAULT NULL, entity_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, actif TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649AF73D997 (direction_id), INDEX IDX_8D93D649BD0F409C (area_id), INDEX IDX_8D93D64981257D5D (entity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_dangerous_situation (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE corrective_action (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, survey_id INT NOT NULL, category_id INT NOT NULL, question_id INT NOT NULL, date_controlle DATETIME NOT NULL, place_construction VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_ECD872CEA76ED395 (user_id), INDEX IDX_ECD872CEB3FE509D (survey_id), INDEX IDX_ECD872CE12469DE2 (category_id), INDEX IDX_ECD872CE1E27F6BF (question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE direction (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, etat TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE dangerous_situation (id INT AUTO_INCREMENT NOT NULL, type_dangerous_situation_id INT NOT NULL, direction_id INT NOT NULL, zone_id INT NOT NULL, entity_id INT NOT NULL, date DATETIME NOT NULL, comment LONGTEXT NOT NULL, photo VARCHAR(255) NOT NULL, INDEX IDX_6C25E8364AC461E8 (type_dangerous_situation_id), INDEX IDX_6C25E836AF73D997 (direction_id), INDEX IDX_6C25E8369F2C3FAB (zone_id), INDEX IDX_6C25E83681257D5D (entity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE survey_question (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, question_type VARCHAR(255) NOT NULL, INDEX IDX_EA000F6912469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE survey (id INT AUTO_INCREMENT NOT NULL, direction_id INT NOT NULL, updated_at DATETIME DEFAULT NULL, team VARCHAR(255) NOT NULL, count_team INT DEFAULT NULL, INDEX IDX_AD5F9BFCAF73D997 (direction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE corrective_action ADD CONSTRAINT FK_ECD872CEB3FE509D FOREIGN KEY (survey_id) REFERENCES survey (id)');
        $this->addSql('ALTER TABLE corrective_action ADD CONSTRAINT FK_ECD872CE12469DE2 FOREIGN KEY (category_id) REFERENCES survey_category (id)');
        ...
        $this->addSql('ALTER TABLE dangerous_situation ADD CONSTRAINT FK_6C25E8369F2C3FAB FOREIGN KEY (zone_id) REFERENCES area (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE corrective_action DROP FOREIGN KEY FK_ECD872CE12469DE2');
        ...
        $this->addSql('ALTER TABLE dangerous_situation DROP FOREIGN KEY FK_6C25E8369F2C3FAB');
        ...
        $this->addSql('ALTER TABLE corrective_action DROP FOREIGN KEY FK_ECD872CEB3FE509D');
