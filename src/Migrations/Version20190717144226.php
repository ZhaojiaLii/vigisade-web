 ...
 */
final class Version20190717144226 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE corrective_action (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, question_id INT DEFAULT NULL, result_id INT DEFAULT NULL, status VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, comment_question LONGTEXT NOT NULL, INDEX IDX_ECD872CEA76ED395 (user_id), INDEX IDX_ECD872CE1E27F6BF (question_id), INDEX IDX_ECD872CE7A7B643 (result_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
