 ...
 */
final class Version20190613093321 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE survey_category (id INT AUTO_INCREMENT NOT NULL, survey_id INT DEFAULT NULL, title LONGTEXT NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_5ABB5FE6B3FE509D (survey_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE survey_question (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, label LONGTEXT NOT NULL, help LONGTEXT NOT NULL, INDEX IDX_EA000F6912469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE survey (id INT AUTO_INCREMENT NOT NULL, direction_id INT DEFAULT NULL, title LONGTEXT NOT NULL, team VARCHAR(255) NOT NULL, count_team INT DEFAULT NULL, best_practice_label VARCHAR(255) NOT NULL, best_practice_help VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_AD5F9BFCAF73D997 (direction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
