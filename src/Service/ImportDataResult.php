...
class ImportDataResult
{
    ...
    public function indexGoogleForms($output)
    {
        ...
        $output->writeln([
            '<comment> # Read Data from file googleForms_resuls.xlsx Succes </comment>',
            '',
        ]);
        ...
        $output->writeln([
            '',
            '==========================================================================================================',
            '==================================== <question>Import results from GoogleForms</question> =====================================',
            '==========================================================================================================',
            '',
        ]);
        ...
        $progressBar->finish();
        $output->writeln(['', '', '<comment>Results, resultQuestion and TeamMember are successfully generated from GoogleForm !</comment>'], '', '');
        ...
        $progressBar->finish();
        $output->writeln(['', '', '<comment> Corrective action are successfully generated from GoogleForm !</comment>']);
    }
}
